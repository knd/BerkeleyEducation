...
typedef struct AggState
{
	...
	long* a;  /* NB186: Constants used for hash functions in CountMin Sketch */
  	long* b;  /* NB186: Constants used for hash functions in CountMin Sketch */
